// wasm/sherpa-onnx-wasm-main-speech.cc
//
// Browser-oriented shared speech entrypoint. This keeps the broader sherpa
// export surface we want for TTS/STT/VAD without inheriting the stale struct
// size assertions from the nodejs-specific entrypoint.
#include <stdio.h>
