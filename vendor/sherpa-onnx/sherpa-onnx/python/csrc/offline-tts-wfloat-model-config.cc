// sherpa-onnx/python/csrc/offline-tts-wfloat-model-config.cc
//
...
void PybindOfflineTtsWfloatModelConfig(py::module *m) {
  using PyClass = OfflineTtsWfloatModelConfig;

  py::class_<PyClass>(*m, "OfflineTtsWfloatModelConfig")
      .def(py::init<>())
