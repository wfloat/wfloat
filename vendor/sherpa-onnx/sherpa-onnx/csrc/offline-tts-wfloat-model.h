// sherpa-onnx/csrc/offline-tts-wfloat-model.h
//
// Copyright (c)  2023  Xiaomi Corporation

#ifndef SHERPA_ONNX_CSRC_OFFLINE_TTS_WFLOAT_MODEL_H_
#define SHERPA_ONNX_CSRC_OFFLINE_TTS_WFLOAT_MODEL_H_
...
class OfflineTtsWfloatModel {
 public:
  ~OfflineTtsWfloatModel();

  explicit OfflineTtsWfloatModel(const OfflineTtsModelConfig &config);

  template <typename Manager>
  OfflineTtsWfloatModel(Manager *mgr, const OfflineTtsModelConfig &config);
  ...
  const OfflineTtsWfloatModelMetaData &GetMetaData() const;
...
#endif  // SHERPA_ONNX_CSRC_OFFLINE_TTS_WFLOAT_MODEL_H_
