...
static sherpa_onnx::OfflineTtsConfig GetOfflineTtsConfig(
  ...
  // wfloat
  tts_config.model.wfloat.model =
      SHERPA_ONNX_OR(config->model.wfloat.model, "");
...
const char *SherpaOnnxOfflineTtsWfloatPrepareText(
  ...
  sherpa_onnx::WfloatPreparedText prepared =
      (tts && tts->impl)
          ? tts->impl->PrepareWfloatText(text, SHERPA_ONNX_OR(emotion, ""),
                                         intensity)
          : sherpa_onnx::PrepareWfloatText(text, SHERPA_ONNX_OR(emotion, ""),
                                           intensity);
