...
#
# Build shared browser speech WASM for sherpa-onnx.
...
mkdir -p build-wasm-simd-speech
pushd build-wasm-simd-speech
...
cmake \
  ...
  -DSHERPA_ONNX_ENABLE_WASM_SPEECH=ON \
